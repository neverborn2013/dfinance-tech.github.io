    ...
    if (dom) {
      ...
      var handleScroll = function handleScroll() {
        if (document.getElementsByTagName("html")[0].scrollTop > top * 0.2) {
          document.getElementById("bg-4")[0].style.opacity = "1";
        }
      };
